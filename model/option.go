...
func InitOptionMap() {
	...
	common.OptionMap["HumanVerificationProvider"] = common.HumanVerificationProvider
	...
	common.OptionMap["FarmBetaEndTime"] = common.FarmBetaEndTime
	common.OptionMap["FarmAdminUserId"] = strconv.Itoa(common.FarmAdminUserId)
	...
	common.OptionMap["TgBotRanchRabbitPrice"] = strconv.Itoa(common.TgBotRanchRabbitPrice)
	common.OptionMap["TgBotRanchTurkeyPrice"] = strconv.Itoa(common.TgBotRanchTurkeyPrice)
	common.OptionMap["TgBotRanchDonkeyPrice"] = strconv.Itoa(common.TgBotRanchDonkeyPrice)
	common.OptionMap["TgBotRanchHorsePrice"] = strconv.Itoa(common.TgBotRanchHorsePrice)
	common.OptionMap["TgBotRanchDeerPrice"] = strconv.Itoa(common.TgBotRanchDeerPrice)
	...
	common.OptionMap["TgBotRanchRabbitGrowSecs"] = strconv.FormatInt(common.TgBotRanchRabbitGrowSecs, 10)
	common.OptionMap["TgBotRanchTurkeyGrowSecs"] = strconv.FormatInt(common.TgBotRanchTurkeyGrowSecs, 10)
	common.OptionMap["TgBotRanchDonkeyGrowSecs"] = strconv.FormatInt(common.TgBotRanchDonkeyGrowSecs, 10)
	common.OptionMap["TgBotRanchHorseGrowSecs"] = strconv.FormatInt(common.TgBotRanchHorseGrowSecs, 10)
	common.OptionMap["TgBotRanchDeerGrowSecs"] = strconv.FormatInt(common.TgBotRanchDeerGrowSecs, 10)
	...
	common.OptionMap["TgBotRanchRabbitMeatPrice"] = strconv.Itoa(common.TgBotRanchRabbitMeatPrice)
	common.OptionMap["TgBotRanchTurkeyMeatPrice"] = strconv.Itoa(common.TgBotRanchTurkeyMeatPrice)
	common.OptionMap["TgBotRanchDonkeyMeatPrice"] = strconv.Itoa(common.TgBotRanchDonkeyMeatPrice)
	common.OptionMap["TgBotRanchHorseMeatPrice"] = strconv.Itoa(common.TgBotRanchHorseMeatPrice)
	common.OptionMap["TgBotRanchDeerMeatPrice"] = strconv.Itoa(common.TgBotRanchDeerMeatPrice)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "FarmBetaAdminBypass" || key == "RegistrationCodeRequired" {
	...
	case "FarmBetaEndTime":
		common.FarmBetaEndTime = value
	case "FarmAdminUserId":
	...
	case "HumanVerificationProvider":
		common.HumanVerificationProvider = value
	...
	case "TgBotRanchRabbitPrice":
		common.TgBotRanchRabbitPrice, _ = strconv.Atoi(value)
	case "TgBotRanchTurkeyPrice":
		common.TgBotRanchTurkeyPrice, _ = strconv.Atoi(value)
	case "TgBotRanchDonkeyPrice":
		common.TgBotRanchDonkeyPrice, _ = strconv.Atoi(value)
	case "TgBotRanchHorsePrice":
		common.TgBotRanchHorsePrice, _ = strconv.Atoi(value)
	case "TgBotRanchDeerPrice":
		common.TgBotRanchDeerPrice, _ = strconv.Atoi(value)
	...
	case "TgBotRanchRabbitGrowSecs":
		common.TgBotRanchRabbitGrowSecs, _ = strconv.ParseInt(value, 10, 64)
	case "TgBotRanchTurkeyGrowSecs":
		common.TgBotRanchTurkeyGrowSecs, _ = strconv.ParseInt(value, 10, 64)
	case "TgBotRanchDonkeyGrowSecs":
		common.TgBotRanchDonkeyGrowSecs, _ = strconv.ParseInt(value, 10, 64)
	case "TgBotRanchHorseGrowSecs":
		common.TgBotRanchHorseGrowSecs, _ = strconv.ParseInt(value, 10, 64)
	case "TgBotRanchDeerGrowSecs":
		common.TgBotRanchDeerGrowSecs, _ = strconv.ParseInt(value, 10, 64)
	...
	case "TgBotRanchRabbitMeatPrice":
		common.TgBotRanchRabbitMeatPrice, _ = strconv.Atoi(value)
	case "TgBotRanchTurkeyMeatPrice":
		common.TgBotRanchTurkeyMeatPrice, _ = strconv.Atoi(value)
	case "TgBotRanchDonkeyMeatPrice":
		common.TgBotRanchDonkeyMeatPrice, _ = strconv.Atoi(value)
	case "TgBotRanchHorseMeatPrice":
		common.TgBotRanchHorseMeatPrice, _ = strconv.Atoi(value)
	case "TgBotRanchDeerMeatPrice":
		common.TgBotRanchDeerMeatPrice, _ = strconv.Atoi(value)
