...
var ranchAnimals = []ranchAnimalDef{
	...
	{"rabbit", "rab", "兔", "🐇", &common.TgBotRanchRabbitPrice, &common.TgBotRanchRabbitGrowSecs, &common.TgBotRanchRabbitMeatPrice},
	{"duck", "duk", "鸭", "🦆", &common.TgBotRanchDuckPrice, &common.TgBotRanchDuckGrowSecs, &common.TgBotRanchDuckMeatPrice},
	{"turkey", "trk", "火鸡", "🦃", &common.TgBotRanchTurkeyPrice, &common.TgBotRanchTurkeyGrowSecs, &common.TgBotRanchTurkeyMeatPrice},
	{"goose", "gos", "鹅", "🪿", &common.TgBotRanchGoosePrice, &common.TgBotRanchGooseGrowSecs, &common.TgBotRanchGooseMeatPrice},
	{"donkey", "dnk", "驴", "🫏", &common.TgBotRanchDonkeyPrice, &common.TgBotRanchDonkeyGrowSecs, &common.TgBotRanchDonkeyMeatPrice},
	...
	{"horse", "hrs", "马", "🐴", &common.TgBotRanchHorsePrice, &common.TgBotRanchHorseGrowSecs, &common.TgBotRanchHorseMeatPrice},
	{"cow", "cow", "牛", "🐄", &common.TgBotRanchCowPrice, &common.TgBotRanchCowGrowSecs, &common.TgBotRanchCowMeatPrice},
	{"deer", "der", "鹿", "🦌", &common.TgBotRanchDeerPrice, &common.TgBotRanchDeerGrowSecs, &common.TgBotRanchDeerMeatPrice},
}
