...
func GetTgBotSettings(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"data": gin.H{
			...
			"farm_prestige_base_price":  common.TgBotFarmPrestigeBasePrice,
			// 银行贷款
			...
			"farm_season_in_yield":         common.TgBotFarmSeasonInYield,
			"farm_season_off_yield":        common.TgBotFarmSeasonOffYield,
			"farm_season_off_event_bonus":  common.TgBotFarmSeasonOffEventBonus,
			"farm_season_off_water_penalty": common.TgBotFarmSeasonOffWaterPenalty,
			...
			// 钓鱼体力系统
			"fish_bait_price":              common.TgBotFishBaitPrice,
			"fish_action_cd":               common.TgBotFishActionCD,
			"fish_stamina_max":             common.TgBotFishStaminaMax,
			"fish_stamina_cost":            common.TgBotFishStaminaCost,
			"fish_stamina_recover_interval": common.TgBotFishStaminaRecoverInterval,
			"fish_stamina_recover_amount":  common.TgBotFishStaminaRecoverAmount,
			"fish_fatigue_enabled":         common.TgBotFishFatigueEnabled,
			"fish_fatigue_threshold":       common.TgBotFishFatigueThreshold,
			"fish_fatigue_decay":           common.TgBotFishFatigueDecay,
